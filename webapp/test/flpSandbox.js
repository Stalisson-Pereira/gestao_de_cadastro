		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestão de Cadastro de Clientes e Produtos",
									"targetURL": "#gestaodecadastro-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gestaodecadastro-display": {
								"semanticObject": "gestaodecadastro",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gestaodecadastro",
									"url": sap.ui.require.toUrl("gestaodecadastro")
								}
							}
						}
					}
